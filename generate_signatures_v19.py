# ─────────────────────────────────────────────────────────────
# generate_signatures_v19.py
# Premium Compact transparent signatures (Golden Ratio)
# Monogram OH at top-right, real handwritten signature at bottom-right
# ─────────────────────────────────────────────────────────────
...
def card(card_id, subtitle, title_accent, wa_color, ig_rows_html, logo_url,
    ...
    # Premium Compact design - width 440px (perfect golden ratio for visual balance)
    # Fully transparent background, borders invert cleanly in dark mode
    return f'''<table cellpadding="0" cellspacing="0" border="0" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.5;max-width:440px;width:100%;border:0;" id="{card_id}">
  <tr>
          ...
          <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
              <tr>
                ...
                <td style="vertical-align:top;text-align:right;width:34px;padding-left:10px;">
                  <img src="{logo_url}" width="34" alt="OH Monogram Logo" style="display:inline-block;border:0;width:34px;height:auto;" />
                </td>
              </tr>
            </table>
...
<body>
  ...
  <div class="header">
    ...
    <p>Премиум Компактный формат (Golden Ratio, 440px) — Бесшовный дизайн на прозрачном фоне</p>
  </div>
...
print('email-signatures.html v19 — premium compact transparent compiled successfully!')
