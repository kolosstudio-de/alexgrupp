...
def make_watermark(image_path, output_path, target_width=180, opacity_factor=0.03):
    ...
    # Extract bands and apply alpha factor
    r, g, b, a = img_resized.split()
    a = a.point(lambda p: int(p * opacity_factor))
    watermark = Image.merge("RGBA", (r, g, b, a))
    # Save the highly-optimized watermark image
    watermark.save(output_path, "PNG")

# Generate the low-opacity watermarks
make_watermark('assets/Photopea Logo White.png', 'assets/logo-watermark-white.png', target_width=180, opacity_factor=0.03)
make_watermark('assets/Photopea Logo Black.png', 'assets/logo-watermark-black.png', target_width=180, opacity_factor=0.025)
...
white_watermark = get_b64('assets/logo-watermark-white.png')
black_watermark = get_b64('assets/logo-watermark-black.png')
...
<body>
  ...
  <!-- ═══════════════════════════════════════════════ -->
  <div>
    <div class="label">📌 Signatur 1 — AUTO (Fahrzeugberatung) - Wasserzeichen Version</div>

    <!-- COPY FROM HERE -->
    <table cellpadding="0" cellspacing="0" border="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 1.5; background: #0f0f0f; background-image: url('data:image/png;base64,{white_watermark}'); background-repeat: no-repeat; background-position: right 40px center; background-size: 180px 230px; border-radius: 10px; overflow: hidden; max-width: 540px; width: 100%; border: 1px solid rgba(255,255,255,0.05);" background="https://www.oleksandrhalushka.de/assets/logo-watermark-white.png">
      <tr>
  ...
  <!-- ═══════════════════════════════════════════════ -->
  <div>
    <div class="label">🔨 Signatur 2 — BAU (Innenausbau) - Wasserzeichen Version</div>

    <!-- COPY FROM HERE -->
    <table cellpadding="0" cellspacing="0" border="0" style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 1.5; background: #ffffff; background-image: url('data:image/png;base64,{black_watermark}'); background-repeat: no-repeat; background-position: right 40px center; background-size: 180px 230px; border-radius: 10px; overflow: hidden; max-width: 540px; width: 100%; border: 1px solid #e2e8f0;" background="https://www.oleksandrhalushka.de/assets/logo-watermark-black.png">
      <tr>
        <td style="padding: 24px;">
          <!-- Main Content Block (Single Column) -->
          <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
  ...
  <!-- ═══════════════════════════════════════════════ -->
  <div>
    <div class="label">💼 Signatur 3 — UNIVERSAL (Allgemein) - Wasserzeichen Version</div>
...
print('email-signatures.html successfully regenerated in final layout with watermark background!')
