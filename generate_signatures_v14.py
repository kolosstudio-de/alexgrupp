# ─────────────────────────────────────────────────────────────
# generate_signatures_v14.py
# Fully transparent background, dark-mode bulletproof signatures
# Works perfectly in light & dark mode, desktop & mobile
# ─────────────────────────────────────────────────────────────

# Permanent CDN assets (Catbox) - Transparent & outline optimized
logo_blue    = 'https://files.catbox.moe/qwt7rq.png'  # high-res blue badge
logo_amber   = 'https://files.catbox.moe/oc02wd.png'  # high-res amber badge
logo_slate   = 'https://files.catbox.moe/lv16k9.png'  # high-res slate badge
sig_outlined = 'https://files.catbox.moe/evih4p.png'  # cursive signature with white glow
...
def card(card_id, subtitle, title_accent, wa_color, ig_rows_html, logo_url,
    ...
    # Fully transparent layout - no hardcoded background or bgcolor
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
              <tr>
                <td style="vertical-align:top;">
                  <div style="font-size:20px;font-weight:800;color:#0f172a!important;letter-spacing:-0.4px;line-height:1.2;">Oleksandr Halushka</div>
                  <div style="font-size:10px;color:{title_accent}!important;font-weight:600;letter-spacing:1px;text-transform:uppercase;margin-top:4px;">{subtitle}</div>
                  <div style="font-size:9px;color:#94a3b8!important;margin-top:2px;">Einzelunternehmer</div>
                </td>
...
{row('Adresse',  f'<span style="color:{value_color}!important;font-size:12px;">{ADDRESS}</span>', label_color)}
{ig_rows_html}
                  </table>
                </td>
  ...
  <tr>
    <td style="padding:10px 24px;border-top:1px solid {border_color};">
      <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
        <tr>
          <td>
            <a href="{SITE}" style="color:#64748b!important;text-decoration:none;font-size:11px;">www.oleksandrhalushka.de</a>
          </td>
          <td style="text-align:right;">
            <a href="{IMPRESSUM}" style="color:#94a3b8!important;text-decoration:none;font-size:11px;">Impressum</a>
          </td>
        </tr>
      </table>
    </td>
...
<head>
  ...
  <style>
    ...
    /* Simulate Dark Mode text color overrides in email client */
    .preview-box.dark table {{
      color: #f1f5f9 !important;
    }}
    .preview-box.dark div, .preview-box.dark span {{
      color: #f1f5f9 !important;
    }}
    .preview-box.dark a {{
...
print('email-signatures.html v14 — dark-mode bulletproof transparent signatures generated successfully!')
