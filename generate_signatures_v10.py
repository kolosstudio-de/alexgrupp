...
# Load the base64 assets (original crisp high-contrast assets)
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                  <tr>
                    ...
                    <td style="vertical-align: top; text-align: right; width: 45px; padding-left: 10px;">
                      <img src="data:image/png;base64,{white_logo}" width="34" height="44" alt="OH Logo" style="display: inline-block; border: 0;" />
                    </td>
                  </tr>
                </table>
              ...
              <td>
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                  <tr>
                    ...
                    <td style="vertical-align: top; text-align: right; width: 45px; padding-left: 10px;">
                      <img src="data:image/png;base64,{black_logo}" width="34" height="44" alt="OH Logo" style="display: inline-block; border: 0;" />
                    </td>
                  </tr>
                </table>
...
print('email-signatures.html successfully regenerated in classic premium layout with sharp logo!')
